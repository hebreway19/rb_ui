...
import { GameTaskExerciseTypes, LessonState, UserRole } from "../../constants";
import { StudentAnswerService } from "../../services";
import { TextTaskContentListPreview } from "../../scenes/Lessons/components";
...
export const StudentPanel = ({exercises = [], task, taskIndex, ...props}) => {
  ...
  }, [currentExercise?._id, answer, props?.mode]);
  ...
  return (
    <Spin spinning={!didLoaded}>
      <Space direction="vertical"
             style={{width: "100%"}}>
        <GameTaskExerciseList role={UserRole.STUDENT}
                              exercises={exercises}
                              mode={props?.mode}
