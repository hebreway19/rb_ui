...
import { ExerciseType, TaskType, UserRole } from "../../constants";
import { AmericanQuestionsForm } from "../../scenes/Lessons/components/Exercise/AmericanQuestions";
import { GiveTitleForm } from "../../scenes/Lessons/components/Exercise/GiveTitleText";
import {
  ChooseWordsByCategoriesForm, CollectSentencesFromWordsForm, EssayForm, ExplainIdeaForm, InsertMissingWordsForm, OrderParagraphsInTextForm, SelectMissingWordsForm,
  SupplementSentencesForm, SupplementTextForm, TextQuestionsForm, TrueFalseQuestionsForm
...
export const TeacherPanel = ({
  ...
  const editExercise = t("actions.edit",
    {
      entity: t("entities.exercise.exercise")
        .toLowerCase()
    });
  ...
  return (
    <>
      <TextTaskExerciseList role={UserRole.TEACHER} taskIndex={taskIndex} taskType={TaskType.TextTask}
