...
import { ExerciseType, TaskType, ViewModes } from "../../constants";
...
export const TextTaskExerciseListForStudent = ({exercises, mode = ViewModes.DEFAULT, onExerciseSelected}: TextTaskExerciseListForStudentProps) => {
  ...
  const taskTypeLabel: string = t(`pages.lesson.form.tasks.taskType.${TaskType.TextTask}`) + ". " + t("entities.exercise.exercises");
