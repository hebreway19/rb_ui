...
export const ExercisesListForStudent = ({exercises, mode = "default", onExerciseSelected}) => {
  const {t} = useTranslation()
  const [selectedExerciseMeta, setSelectedExerciseMeta] = useState({__t: "", _id: ""});
  const currentExercises = exercises.filter(({__t, _id}) => Object.values(ExerciseType)
    .includes(__t));
