...
import { EssayForm, ExercisesList, TextQuestionsForm, TextTaskContentListPreview } from "../..";
  ...
  return (
    <Spin spinning={!didLoaded}>
      <Space direction="vertical"
             style={{width: "100%"}}>
        <ExercisesList role={UserRole.STUDENT}
                       exercises={exercises}
                       mode={props?.mode}
                ...
                <Row justify="end"
                  ...
                  <Col xs={14}>
                    <HebButton onClick={() => commitAnswer(currentExercise._id, answer)}
                               block
                               loading={isSending}
                               children={sendAnswerButtonLabel}
                               icon={<SaveOutlined />} />
                  </Col>
                </Row>
              </Col>
