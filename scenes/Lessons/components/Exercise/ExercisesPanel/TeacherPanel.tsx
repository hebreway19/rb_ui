...
import { AmericanQuestionsForm } from "../AmericanQuestions";
import { GiveTitleForm } from "../GiveTitleText";
import {
  ChooseWordsByCategoriesForm, CollectSentencesFromWordsForm, EssayForm, ExercisesList, ExplainIdeaForm, InsertMissingWordsForm, OrderParagraphsInTextForm, SelectMissingWordsForm,
...
import { ExerciseTour } from "../ExerciseTour";
import { HebButton, HebModal, HebTooltip, HebTypography } from "../../../../../components/HebElements";
...
export const TeacherPanel = ({
  ...
  return (
    <>
      <ExercisesList role={UserRole.TEACHER}
                     taskIndex={taskIndex}
                     exercises={exercises}
      ...
      <HebModal visible={selectedExerciseType}
                style={{top: 20}}
                onCancel={onCancel}
                className="teacher-exercise-panel"
                footer={footer}
